    ...
    <section className="relative min-h-screen flex items-center justify-center py-32 overflow-hidden">
      <div className="max-w-5xl mx-auto px-6 relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start">
          ...
          >
            {/* Education Card */}
            <motion.div variants={itemVariants} className="relative p-8 rounded-3xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-sm overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 dark:bg-blue-500/20 blur-3xl rounded-full" />
            ...
            <motion.div variants={itemVariants} className="relative p-8 rounded-3xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-sm overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-violet-500/10 dark:bg-violet-500/20 blur-3xl rounded-full" />
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400">Community Involvement</p>
                </div>
              </div>

              <div className="relative z-10 p-5 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5">
